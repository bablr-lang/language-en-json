...
export default class JSON {
  ...
  *Number() {
    ...
    let fs = yield eatMatch(m`decimalSeparatorToken*: <* '.' />`, o({}), o({ bind: true }));
    ...
    let es = yield eatMatch(m`exponentSeparatorToken*: <* /[eE]/ />`, o({}), o({ bind: true }));

    yield eatMatch(m`exponentSign*: <* /[+-]/ />`, o({}), o({ bind: true }));
