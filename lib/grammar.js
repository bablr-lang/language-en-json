 ...
 * @generatedfrom ./grammar.macro.js#5001ce6c65e8218a6e14f92bc8d4f2f205fd4f3f
...
export const grammar = triviaEnhancer({
  ...
  *Expression() {
    yield eat(m`<Any />`, [m`<Array '[' />`, m`<Object '{' />`, m`<String /['"]/ />`, m`<Number /-?\d/ {span: 'Number'} />`, m`<Infinity 'Infinity' />`, m`<NaN 'NaN' />`, m`<Null 'null' />`, m`<Boolean /true|false/ />`]);
  }
  *Array() {
