 ...
 * @generatedfrom ./grammar.macro.js#bc99b88a0e3cef5b19032199226a6235047efef0
...
export const grammar = triviaEnhancer(
  ...
  ((_dec = CoveredBy('Element')),
  (_dec2 = CoveredBy('Expression')),
  (_dec3 = CoveredBy('Expression')),
  (_dec4 = CoveredBy('Language')),
  (_dec5 = Attributes(['cooked'])),
  (_dec6 = CoveredBy('Expression')),
  (_dec7 = CoveredBy('Expression')),
  (_dec8 = CoveredBy('Expression')),
  (_dec9 = InjectFrom(productions)),
  (_dec10 = InjectFrom(productions)),
  (_dec11 = InjectFrom(productions)),
  (_dec12 = InjectFrom(productions)),
  class JSONGrammar {
    static {
      [_initProto] = _applyDecs(
        ...
        [
          ...
          [[_dec5, Node], 2, 'EscapeSequence'],
          [Node, 2, 'EscapeCode'],
          [[_dec6, Node], 2, 'Number'],
          [Node, 2, 'Integer'],
          [Node, 2, 'Digit'],
          [[_dec7, Node], 2, 'Boolean'],
          [[_dec8, Node], 2, 'Null'],
          [[Node, _dec9], 2, 'Keyword'],
          [[Node, _dec10], 2, 'Punctuator'],
          [[AllowEmpty, _dec11], 2, 'List'],
          [_dec12, 2, 'Any'],
        ],
        [],
      ).e;
