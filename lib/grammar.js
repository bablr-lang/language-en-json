 ...
 * @generatedfrom ./grammar.macro.js#858cdb4c1e45e2a298d07a034061c3cf61dedfef
...
export const grammar = triviaEnhancer({
  ...
  *Expression() {
    yield eat(m`<Any />`, [m`<Array '[' />`, m`<Object '{' />`, m`<String '"' />`, m`<Number /-?\d/ span='Number' />`, m`<Null 'null' />`, m`<Boolean /true|false/ />`]);
  }
  *Array() {
    yield eat(m`openToken: <*Punctuator '[' balanced=']' />`);
    yield eat(m`elements[]$: <List />`, o({
